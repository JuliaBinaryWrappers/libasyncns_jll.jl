...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libasyncns_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("ed080073-db63-57db-a029-74e11ae80737"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libasyncns", artifacts_toml) for e in artifacts["libasyncns"]]
...
if best_platform === nothing
    @debug("Unable to load libasyncns; unsupported platform $(triplet(platform_key_abi()))")
else
